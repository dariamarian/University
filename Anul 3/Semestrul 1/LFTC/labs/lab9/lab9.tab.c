...
{
      23,     0,    -1,    24,    -1,    25,    26,    -1,     3,     7,
      10,    11,    -1,    12,    27,    13,    -1,    28,    27,    -1,
      28,    -1,    29,     9,    -1,    31,     9,    -1,    32,     9,
      -1,    33,     9,    -1,    34,     9,    -1,    16,     8,    30,
      -1,    30,    18,    30,    -1,    30,    19,    30,    -1,    30,
      20,    30,    -1,    30,    21,    30,    -1,    16,    -1,    17,
      -1,     3,    16,    -1,     4,    14,    16,    -1,     5,    15,
      30,    -1,     6,    30,    -1
};
...
{
       0,    59,    59,    62,    65,    68,    71,    72,    75,    76,
      77,    78,    79,    82,    97,   107,   117,   127,   137,   138,
     141,   153,   171,   190
};
#endif
...
{
  "$end", "error", "$undefined", "INT", "CIN", "COUT", "RETURN", "MAIN",
  "ASSIGN", "SEMICOLON", "LPR", "RPR", "LAC", "RAC", "READ", "WRITE", "ID",
  "CONST", "PLUS", "MINUS", "MUL", "DIV", "$accept", "program", "function",
  "header", "compound_statement", "instr_comp", "instr", "assign",
  "expr_arit", "decl", "input_instr", "output_instr", "return_instr", 0
};
#endif
...
static const yytype_uint8 yydefact[] =
{
       0,     0,     0,     2,     0,     0,     1,     0,     3,     0,
       0,     0,     0,     0,     0,     0,     7,     0,     0,     0,
       0,     0,     4,    20,     0,     0,    18,    19,    23,     0,
       5,     6,     8,     9,    10,    11,    12,    21,    22,     0,
...
{
       0,     6,    21,   -26,    10,    13,   -26,     2,   -26,    14,
       8,    12,    15,   -15,    19,    16,     2,    22,    23,    24,
      25,    26,   -26,   -26,    20,   -15,   -26,   -26,    -9,   -15,
     -26,   -26,   -26,   -26,   -26,   -26,   -26,   -26,    -9,   -15,
     -15,   -15,   -15,    -9,    -1,    -1,   -26,   -26
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -26,   -26,   -26,   -26,   -26,    27,   -26,   -26,   -25,   -26,
     -26,   -26,   -26
};
...
{
      38,    26,    27,     1,    43,    10,    11,    12,    13,    39,
      40,    41,    42,     5,    44,    45,    46,    47,    14,    41,
      42,     6,     7,     9,    23,    22,    24,    29,     0,    30,
      25,    32,    33,    34,    35,    36,    37,     0,     0,     0,
       0,     0,     0,    31
};

static const yytype_int8 yycheck[] =
{
      25,    16,    17,     3,    29,     3,     4,     5,     6,    18,
      19,    20,    21,     7,    39,    40,    41,    42,    16,    20,
      21,     0,    12,    10,    16,    11,    14,     8,    -1,    13,
      15,     9,     9,     9,     9,     9,    16,    -1,    -1,    -1,
      -1,    -1,    -1,    16
};
...
{
       0,     3,    23,    24,    25,     7,     0,    12,    26,    10,
       3,     4,     5,     6,    16,    27,    28,    29,    31,    32,
      33,    34,    11,    16,    14,    15,    16,    17,    30,     8,
      13,    27,     9,     9,     9,     9,     9,    16,    30,    18,
      19,    20,    21,    30,    30,    30,    30,    30
};
...
#line 83 "lab9.y"
    {
					...
					parseExpression((yyvsp[(1) - (3)].value));
				;}
    break;
...
#line 154 "lab9.y"
    {
					...
					strcat(sourceCode[lenSourceCode++], (yyvsp[(3) - (3)].value));
