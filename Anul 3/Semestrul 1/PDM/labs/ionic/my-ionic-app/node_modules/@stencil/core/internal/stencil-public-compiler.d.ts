 ...
 */
type StrictConfigFields = 'cacheDir' | 'devServer' | 'extras' | 'flags' | 'hydratedFlag' | 'logger' | 'logLevel' | 'outputTargets' | 'packageJsonFilePath' | 'rollupConfig' | 'rootDir' | 'srcDir' | 'srcIndexHtml' | 'sys' | 'testing' | 'transformAliasedImportPaths' | 'validatePrimaryPackageOutputTarget';
/**
