...
public:
	...
	ServiceMasina(RepoMasini& rep, MasinaValidator& val) :rep{ rep }, val{ val } {}
   ...
   /*
	unordered_map <int, Masina> getAll() noexcept {
		return rep.getAll();
	} */
...
public:
	ServiceSpalat(RepoMasini& _rep, Spalat& _sp, MasinaValidator& _val) : rep{ _rep }, sp{ _sp }, val{ _val }{}
