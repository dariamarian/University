...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_examen_t, stringdata0) + ofs), len 
...
const QMetaObject examen::staticMetaObject = { {
    ...
    qt_meta_stringdata_examen.offsetsAndSize,
    qt_meta_data_examen,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_examen_t
