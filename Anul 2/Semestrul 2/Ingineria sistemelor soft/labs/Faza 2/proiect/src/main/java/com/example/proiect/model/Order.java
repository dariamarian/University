...
public class Order implements com.example.proiect.model.Entity<Integer>{
    ...
    public Order(int idPersonnel, int idPharmaceutist, int idMedication, int quantity, String timeTaken, String comments, Status status) {
        this.medicalPersonnel=new MedicalPersonnel();
        medicalPersonnel.setId(idPersonnel);
        this.pharmaceutist=new Pharmaceutist();
        pharmaceutist.setId(idPharmaceutist);
