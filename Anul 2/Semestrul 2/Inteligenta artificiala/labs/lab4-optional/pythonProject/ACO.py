...
class ACO(object):
    def __init__(self, ant_count: int, iterations: int, alpha: float, beta: float, rho: float, q: int):
        self.Q = q  # intensitatea feromonului
        self.rho = rho  # coeficientul de degradare
        self.beta = beta  # controleaza influenta distantei
        self.alpha = alpha  # controleaza influenta feromonilor
        self.ant_count = ant_count  # numarul de furnici
        self.iterations = iterations  # numarul de iteratii
