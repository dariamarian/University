...
public class RepoAngajat implements IRepoAngajat {
    ...
    @Override
    public Angajat findElement(Long aLong) {
        logger.traceEntry();
        ...
        try (Connection connection = jdbcUtils.getConnection();
            ...
            while (resultSet.next()) {
                ...
                angajat=new Angajat(name,username,pass);
            }
        } catch (SQLException e) {
            logger.error(e);
            e.printStackTrace();
    ...
    public Iterable<Angajat> getAll() {
        ...
        try (Connection connection = jdbcUtils.getConnection();
            ...
            while (resultSet.next()) {
                ...
                Angajat angajat=new Angajat(name,username,pass);
    ...
    public Angajat authenticateAngajat(String username, String password) {
        ...
        try (Connection connection = jdbcUtils.getConnection();
            ...
            while (resultSet.next()) {
                ...
                String pass = resultSet.getString("password");
                angajat = new Angajat(name, usernm, pass);
                angajat.setId(id);
            }
        } catch (SQLException e) {
            logger.error(e);
