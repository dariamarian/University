...
import proiectServerClientJava.network.protobuffprotocol.ProtoClientProxy;
...
public class StartProtobuffClient extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try {
            clientProps.load(StartProtobuffClient.class.getResourceAsStream("/angajat.properties"));
            System.out.println("Client properties set. ");
            clientProps.list(System.out);
        } catch (IOException e) {
            System.err.println("Cannot find angajat.properties "+e);
            return;
        }
        ...
        IService service=new ProtoClientProxy(serverIP, serverPort);
